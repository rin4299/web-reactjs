...
// }).unless({
// 	path: ['/users', '/metrics', '/channels/:channelName/chaincodes/:chaincodeName']
// }));
// app.use(bearerToken());
...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
	try {
		...
		let message = await invoke.invokeChaincode(peers, channelName, chaincodeName, fcn, args, "user", "Org1");
...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
	...
	let message = await query.queryChaincode(peer, channelName, chaincodeName, args, fcn, "user", "Org1");
